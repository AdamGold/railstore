...
@@headers = {"X-PAYPAL-SERVICE-VERSION" => "1.0.0","X-PAYPAL-SECURITY-USERID" => "railsd_1304439789_biz_api1.gmail.com","X-PAYPAL-SECURITY-PASSWORD" =>"AXMZRSLMZD2EW9YT", "X-PAYPAL-SECURITY-SIGNATURE" => "AGr8bUTuQUs5gBnP4jrz-myHnypZAlPUMifrO6afuLWqZ8..0NxM.T.l", "X-PAYPAL-APPLICATION-ID" => "APP-80W284485P519543T","X-PAYPAL-DEVICE-IPADDRESS"=>"127.0.0.1" , "X-PAYPAL-REQUEST-DATA-FORMAT" => "NV" , "X-PAYPAL-RESPONSE-DATA-FORMAT" => "NV"}
